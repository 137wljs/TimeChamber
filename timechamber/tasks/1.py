...
class MA_Ant_Bug_Battle(VA_VecTask):
    ...
    def __init__(self, cfg, sim_device, rl_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.stay_in_center_reward_scale = 5.
        self.action_cost_scale = -0.000025
        # self.action_cost_scale = 0. # 先专注在位移上
        self.flipped_scale = -10 # 翻倒惩罚
        self.move_scale = 10. # 位移奖励
...
def compute_agent_reward(
    ...
    # type: (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, float, int, float, float, float, float, float, float, float, float, float, float, float, float, int, int) -> Tuple[Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor]
    ...
    ant_dense_reward = ant_rank_reward + ant_dof_at_limit_cost.transpose(0,1) + ant_action_cost_penalty + ant_not_move_penalty + ant_stay_in_center_reward.transpose(0, 1) + ant_flipped_penalty.transpose(0, 1) + ant_tend_to_flip_penalty.transpose(0, 1) + ant_push_bug_reward.transpose(0, 1) + ant_move_reward.transpose(0, 1)
    bug_dense_reward = bug_rank_reward + bug_dof_at_limit_cost.transpose(0,1) + bug_action_cost_penalty + bug_not_move_penalty + bug_stay_in_center_reward.transpose(0, 1) + bug_flipped_penalty.transpose(0, 1) + bug_tend_to_flip_penalty.transpose(0, 1) + bug_push_ant_reward.transpose(0, 1) + bug_move_reward.transpose(0, 1)
    ...
    # print(nxt_rank)
    # print("================")
    # print(ant_rank_reward)
    # print("================")
    # print(bug_rank_reward)
    # print("================")
    ...
    # print(bug_stay_in_center_reward.transpose(0, 1))
    # print("================")
    ...
    # print("================")
    # print(bug_move_reward.transpose(0, 1))
    # print("===============reward end============")
